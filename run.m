% run script to play jROPE algorithm to estimate revverberation time (RT) and
...
% Verion 0.1:   10 May 2019 (only jROPE-II included; Kaldi required to be installed)
% 
% If you use this software in a publication, please cite:
%
% F. Xiong, S. Goetze, B. Kollmeier, B. T. Meyer, "Joint Estimation of Reverberation 
% Time and Early-To-Late Reverberation Ratio From Single-Channel Speech Signals", 
% In: IEEE/ACM Transactions on Audio, Speech, and Language Processing 27(2), pp. 255-267, 2019.
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
jrope_mdl = 'models/jropeII_fullband_mlp.raw';

% nnet3-computee
jrope_est_mxt = calculate_nnet3_compute( auditory_feature, jrope_mdl, kaldi_src );
...
rt_est = calculate_temporal_average( jrope_est_mxt, 'rt' );
elr_est = calculate_temporal_average( jrope_est_mxt, 'elr' );

disp([ '###### The Estimate (jROPE-II) of fullband RT is ' num2str(rt_est) ' ms ...']);
disp([ '###### The Estimate (iROPE-II) of fullband ELR is ' num2str(elr_est) ' dB ...']);
